...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HttpRequest getRequest =
            HttpRequestDirector.createGetRequest(
        ...
        HttpRequest postRequest =
            HttpRequestDirector.createJsonPostRequest(
                "https://api.example.com/users",
    ...
    static class HttpRequestDirector {
        ...
        public static HttpRequest createJsonPostRequest(
            String url,
            String jsonBody
        ) {
